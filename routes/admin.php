...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::group(['prefix' => 'categoryproduct'], function () {
        ...
        Route::get('/update-order', "AdminCategoryProductController@updateOrder")->name('updateOrder');

        Route::get('/update-hot/{id}', "AdminCategoryProductController@loadHot")->name("admin.categoryproduct.load.hot");
        Route::get('/update-active/{id}', "AdminCategoryProductController@loadActive")->name("admin.categoryproduct.load.active");
        ...
        Route::get('/delete-avatar-path/{id}', "AdminCategoryProductController@destroyCategoryProductAvatar")->name("admin.categoryproduct.delete_avatar_path")->middleware('can:category-product-edit');
        Route::get('/delete-icon-path/{id}', "AdminCategoryProductController@destroyCategoryProductIcon")->name("admin.categoryproduct.delete_icon_path")->middleware('can:category-product-edit');
        Route::get('/delete-file/{id}', "AdminCategoryProductController@destroyCategoryProductFile")->name("admin.categoryproduct.delete_file")->middleware('can:category-product-edit');
    });
    ...
    Route::group(['prefix' => 'categorypost'], function () {
        ...
        Route::get('/update-hot/{id}', "AdminCategoryPostController@loadHot")->name("admin.categorypost.load.hot");
        Route::get('/update-active/{id}', "AdminCategoryPostController@loadActive")->name("admin.categorypost.load.active");

        Route::get('/delete-avatar-path/{id}', "AdminCategoryPostController@destroyCategoryPostAvatar")->name("admin.categorypost.delete_avatar_path")->middleware('can:category-post-edit');
        Route::get('/delete-icon-path/{id}', "AdminCategoryPostController@destroyCategoryPostIcon")->name("admin.categorypost.delete_icon_path")->middleware('can:category-post-edit');
    });
    ...
    Route::group(['prefix' => 'galaxy'], function () {
        Route::get('/', "AdminGalaxyController@index")->name("admin.galaxy.index");
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('/show/{id}', "AdminProductController@editProductTab")->name("admin.product.show");
        ...
        Route::post('/upload-image', "AdminProductController@uploadFileImage")->name("admin.product.upload-image")->middleware('can:product-add');


        //Sao chep
        Route::get('/coppy/{id}', "AdminProductController@coppy")->name("admin.product.coppy")->middleware('can:product-edit');
        Route::post('/update-coppy/{id}', "AdminProductController@updateCoppy")->name("admin.product.update_coppy")->middleware('can:product-edit');
        ...
        Route::get('/delete-file/{id}', "AdminProductController@destroyProductFile")->name("admin.product.delete_file")->middleware('can:product-edit');
        Route::get('/delete-file2/{id}', "AdminProductController@destroyProductFile2")->name("admin.product.delete_file2")->middleware('can:product-edit');
        ...
        Route::post('delete-multiple', "AdminProductController@deleteMultiple")->name('admin.product.multiple_product_delete');

        Route::post('upload-file-new', "AdminProductController@uploadFileNew")->name('admin.product.uploadFileNew');

        //save map
        Route::post('/save-map', "AdminProductController@saveMap")->name('admin.product.saveMap');
    });
    ...
    Route::group(['prefix' => 'destination'], function () {
        Route::get('/', "AdminDestinationController@index")->name("admin.destination.index")->middleware('can:post-list');
        Route::get('/create', "AdminDestinationController@create")->name("admin.destination.create")->middleware('can:post-add');
        Route::post('/store', "AdminDestinationController@store")->name("admin.destination.store")->middleware('can:post-add');
        Route::get('/edit/{id}', "AdminDestinationController@edit")->name("admin.destination.edit")->middleware('can:post-edit');
        Route::post('/update/{id}', "AdminDestinationController@update")->name("admin.destination.update")->middleware('can:post-edit');
        Route::get('/destroy/{id}', "AdminDestinationController@destroy")->name("admin.destination.destroy")->middleware('can:post-delete');

        Route::get('/update-hot/{id}', "AdminDestinationController@loadHot")->name("admin.destination.load.hot")->middleware('can:post-edit');
    });

    Route::group(['prefix' => 'topic'], function () {
        Route::get('/', "AdminTopicController@index")->name("admin.topic.index")->middleware('can:post-list');
        Route::get('/create', "AdminTopicController@create")->name("admin.topic.create")->middleware('can:post-add');
        Route::post('/store', "AdminTopicController@store")->name("admin.topic.store")->middleware('can:post-add');
        Route::get('/edit/{id}', "AdminTopicController@edit")->name("admin.topic.edit")->middleware('can:post-edit');
        Route::post('/update/{id}', "AdminTopicController@update")->name("admin.topic.update")->middleware('can:post-edit');
        Route::get('/destroy/{id}', "AdminTopicController@destroy")->name("admin.topic.destroy")->middleware('can:post-delete');

        Route::get('/update-hot/{id}', "AdminTopicController@loadHot")->name("admin.topic.load.hot")->middleware('can:post-edit');
    });
    ...
    Route::group(['prefix' => 'post'], function () {
        ...
        Route::get('/list-comment', "AdminPostController@ListComment")->name("admin.post.comment");

        Route::get('/update-active-comment/{id}', "AdminPostController@loadActivecomment")->name("admin.post.load.activecomment");
        Route::get('/destroy-comment/{id}', "AdminPostController@destroycomment")->name("admin.post.destroycomment");
    ...
    Route::group(['prefix' => 'slider'], function () {
        ...
        Route::get('/delete-image-path/{id}', "AdminSliderController@destroyImage")->name("admin.slider.delete_image_path")->middleware('can:slider-edit');
    });
    ...
    Route::group(['prefix' => 'setting'], function () {
        ...
        Route::get('/delete-image-path/{id}', "AdminSettingController@destroySettingImage")->name("admin.setting.delete_image_path")->middleware('can:setting-edit');
        Route::get('/delete-image-path1/{id}', "AdminSettingController@destroySettingImage1")->name("admin.setting.delete_image_path1")->middleware('can:setting-edit');
    });
    ...
    Route::group(['prefix' => 'contact'], function () {
        ...
        Route::get('/booking', "AdminContactController@booking")->name("admin.contact.booking");
        Route::patch('/booking/{id}/change-status', "AdminContactController@changeStatus")->name("admin.contact.booking.changeStatus");
        Route::patch('/booking/{id}/change-sale', "AdminContactController@changeSale")->name("admin.contact.booking.changeSale");
    ...
    Route::group(['as' => 'admin.'], function () {
        ...
        Route::patch('/service-change-active/{id}', "ServiceController@changeActive")->name("service.changeActive");
        Route::patch('/service-change-order/{id}', "ServiceController@changeOrder")->name("service.changeOrder");
        Route::get('/service-child/{id}', "ServiceController@getServiceChild")->name("service.getChild");

        Route::resource('/service-full', "ServiceFullController");
        Route::patch('/service-full-change-active/{id}', "ServiceFullController@changeActive")->name("service-full.changeActive");
        Route::patch('/service-full-change-order/{id}', "ServiceFullController@changeOrder")->name("service-full.changeOrder");
        Route::get('/service-full-child/{id}', "ServiceFullController@getServiceChild")->name("service-full.getChild");

        Route::resource('/service-class', "ServiceClassController");
        Route::patch('/service-class-change-active/{id}', "ServiceClassController@changeActive")->name("service-class.changeActive");
        Route::patch('/service-class-change-order/{id}', "ServiceClassController@changeOrder")->name("service-class.changeOrder");

        Route::resource('/service-other', "ServiceOtherController");
        Route::patch('/service-other-change-active/{id}', "ServiceOtherController@changeActive")->name("service-other.changeActive");
        Route::patch('/service-other-change-order/{id}', "ServiceOtherController@changeOrder")->name("service-other.changeOrder");

        Route::resource('/service-type', "ServiceTypeController");
        Route::patch('/service-type-change-active/{id}', "ServiceTypeController@changeActive")->name("service-type.changeActive");
        Route::patch('/service-type-change-order/{id}', "ServiceTypeController@changeOrder")->name("service-type.changeOrder");
        ...
        Route::patch('/additional-fee-change-active/{id}', "AdditionalFeeController@changeActive")->name("additional-fee.changeActive");
        Route::patch('/additional-fee-change-order/{id}', "AdditionalFeeController@changeOrder")->name("additional-fee.changeOrder");
