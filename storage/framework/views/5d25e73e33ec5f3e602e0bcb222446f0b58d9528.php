...
<?php $__env->startSection('title', 'List service option full tour'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(route('admin.service-full-option.saveInformation')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="box-service-option title">
                                                ...
                                                <div class="d-flex">
                                                    <button class="btn btn-warning mx-2 trigger-modal-btn"
                                                        ...
                                                        data-url="<?php echo e(route('admin.service-full-season.update', ['service_full_season' => $item->id])); ?>">Update</button>
                                                    <button class="btn btn-danger delete-record"
                                                        data-url="<?php echo e(route('admin.service-full-season.destroy', ['service_full_season' => $item->id])); ?>"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $item->services()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo e(route('admin.service-full-option.edit', ['service_full_option' => $option->id])); ?>"
                                                                        class="btn btn-warning delete-record-option">Edit</a>
                                                                    <button
                                                                        data-url="<?php echo e(route('admin.service-full-option.destroy', ['service_full_option' => $option->id])); ?>"
                                                                        data-method="DELETE"
                                                        ...
                                                        <tr>
                                                            <td colspan="5" style="cursor: pointer">
                                                                <a
                                                                    href="<?php echo e(route('admin.service-full-option.create', ['service_id' => $service->id, 'service_season_id' => $item->id])); ?>">
    ...
    <div class="custom-modal-overlay" id="custom-modal">
        <form id="customForm" action="<?php echo e(route('admin.service-full-season.store', ['service_id' => $service->id])); ?>"
            method="POST" data-type="create">
            <div class="custom-modal">
                <div class="custom-modal-header">
                    <h2 class="custom-modal-title"> Season</h2>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\demo22\resources\views/admin/pages/service-full-option/index.blade.php ENDPATH**/ ?>