...
<?php $__env->startSection('title', 'Create service option full tour'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <?php echo $__env->make('admin.partials.content-header', [
            'name' => 'Service option',
            'key' => 'Create service option full tour',
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row" action="<?php echo e(route('admin.service-full-option.store')); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="service_id" value="<?php echo e($service_id); ?>">
                                        <input type="hidden" name="service_season_id" value="<?php echo e($service_season_id); ?>">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Service option:</label>
                                                <input type="text"
                                                    class="form-control <?php if($errors->has('name')): ?> is-invalid <?php endif; ?>"
                                                    id="name" placeholder="Service option" value="<?php echo e(old('name')); ?>"
                                                    name="name">
                                                ...
                                                <select name="service_type_id" id="service_type_id"
                                                    ...
                                                    <?php $__currentLoopData = $servicesType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value->id); ?>"
                                                            ...
                                                            <?php echo e(old('service_type_id') == $value->id ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="type" placeholder="Type" value="<?php echo e(old('type')); ?>"
                                                    name="type">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MinhDuc\Desktop\demo22\resources\views/admin/pages/service-full-option/create.blade.php ENDPATH**/ ?>