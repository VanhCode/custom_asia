...
<?php $__env->startSection('title', 'Update service other'); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row"
                                        action="<?php echo e(route('admin.service-other.update', ['service_other' => $serviceOther->id])); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="<?php echo e(old('name') ?? $serviceOther->name); ?>" name="name">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="<?php echo e(old('order') ?? $serviceOther->order); ?>">
                                                ...
                                                <div class="d-flex">
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="1"
                                                            id="status-active"
                                                            <?php if(old('active') === '1' || $serviceOther->active == 1): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                                        <label for="status-active">Active</label>
                                                    </div>
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="0" id="status-hide"
                                                            <?php if(old('active') === '0' || $serviceOther->active == 0): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" id="description" class="ckeditor">
                                                <?php echo e(old('description') ?? $serviceOther->description); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MinhDuc\Desktop\demo22\resources\views/admin/pages/service-other/edit.blade.php ENDPATH**/ ?>