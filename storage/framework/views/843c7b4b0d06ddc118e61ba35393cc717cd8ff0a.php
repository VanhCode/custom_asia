...
<body>
    <div class="box_404">
        <div class="img_404">
            <img src="<?php echo e(asset('frontend/images/img_404.png')); ?>" alt="404">
        </div>
        <div class="bug_404">
            Page not found!
        </div>
        <div class="menu_line">
            <a href="<?php echo e(makeLink('home')); ?>">Quay lại Trang Chủ</a>
        </div>
    </div>
...
<?php /**PATH C:\Users\MinhDuc\Desktop\custom_asia\resources\views/errors/404.blade.php ENDPATH**/ ?>