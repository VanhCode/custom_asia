...
<?php $__env->startSection('title', 'Create service other'); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row" action="<?php echo e(route('admin.service-other.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="name" placeholder="Service other" value="<?php echo e(old('name')); ?>"
                                                    name="name">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MinhDuc\Desktop\demo22\resources\views/admin/pages/service-other/create.blade.php ENDPATH**/ ?>