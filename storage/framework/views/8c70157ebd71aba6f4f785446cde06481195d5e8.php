...
<?php $__env->startSection('title', 'List service'); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                            <?php if(request()->parent_id): ?>
                                <a href="<?php echo e(route('admin.service.index', ['parent_id' => 0])); ?>"
                                    class="custom-btn yellow mx-2">Go back</a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('admin.service.create', ['parent_id' => request()->parent_id ?? 0])); ?>"
                                            ...
                                            <?php if(isset($services) && $services->count() > 0): ?>
                                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="<?php echo e(route('admin.service.index', ['parent_id' => $item->id])); ?>">
                                                        ...
                                                        <td>
                                                            <input type="number" id="order-quantity"
                                                                ...
                                                                data-url="<?php echo e(route('admin.service.changeOrder', ['id' => $item->id])); ?>"
                                                                data-method="PATCH" placeholder="0"
                                                                value="<?php echo e($item->order); ?>" min="0">
                                                        </td>
                                                        <td>
                                                            <button
                                                                data-url="<?php echo e(route('admin.service.changeActive', ['id' => $item->id])); ?>"
                                                                data-method="PATCH"
                                                                class="btn btn-danger change-active <?php echo e($item->active ? 'active' : ''); ?>"><?php echo e($item->active ? 'Active' : 'Hide'); ?></button>
                                                        </td>
                                                        <td>
                                                            <?php if(request()->parent_id): ?>
                                                                <a href="<?php echo e(route('admin.service-option.index', ['service_id' => $item->id])); ?>"
                                                                    class="btn btn-sm btn-success">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                            <a href="<?php echo e(route('admin.service.edit', ['service' => $item->id, 'parent_id' => request()->parent_id ?? 0])); ?>"
                                                                class="btn btn-sm btn-warning">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <button
                                                                data-url="<?php echo e(route('admin.service.destroy', ['service' => $item->id])); ?>"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MinhDuc\Desktop\demo22\resources\views/admin/pages/service/index.blade.php ENDPATH**/ ?>