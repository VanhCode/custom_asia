                                    ...
                                    <div class="clm" style="--w-lg: 8;">
                                        ...
                                        <div class="form-group">
                                            <input class="w-100" type="text" name="email" id=""
                                                   placeholder="Email"
                                                   value="<?php echo e(isset($booking) ? $booking->email : ''); ?>">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-column">
                                            <div class="content-text d-flex justify-content-between">
                                                <div>
                                                    <h5>Trip: <?php echo e($item->tour_name); ?></h5>
                                                </div>
                                                <div>
                                                    <a target="_blank" href="<?php echo e(route('admin.my-trip.copy', ['id' => $item->id])); ?>">Copy Tour</a>
                                                </div>
                                            </div>
                                            <div class="content-text">
                                                <span>Number adult: <?php echo e($item->adult_number); ?></span>
                                            </div>
                                            <div class="content-text">
                                                <span>Customer Name: <?php echo e($item->title_name); ?> <?php echo e($item->first_name); ?> <?php echo e($item->last_name); ?></span>
                                            </div>
                                            <div class="content-text">
                                                <span>Number Day: <?php echo e($item->day_number ?? '( No data )'); ?></span>
                                            </div>
                                            <div class="content-text">
                                                <span>Start Date: <?php echo e(\Carbon::parse($item->date_start)->format('m/d/Y')); ?></span>
                                            </div>
                                            <div class="content-text">
                                                <span>Total Cost: <?php echo e(number_format($item->final_cost)); ?> VND</span>
                                            </div>
                                            <div class="content-text">
                                                <span>Total Cost/ Person: <?php echo e(number_format($item->final_cost_per_person)); ?> VND</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\demo22\resources\views/admin/pages/my-trip/create.blade.php ENDPATH**/ ?>