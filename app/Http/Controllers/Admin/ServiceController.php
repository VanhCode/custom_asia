...
class ServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pages.service.index', compact('services', 'parent'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.pages.service.create', compact('parent'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.service.index', ['parent_id' => $request->parent_id])->with('alert', config('ajax.messages.success.created'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.service.edit', compact('service', 'parent'));
    }
