...
class ServiceFullOptionController extends Controller
{
    ...
    public function __construct(
        ...
        ServiceFullOption $serviceOption,
    ...
    public function index(Request $request)
    {
        if ($request->input('service_id')) {
            ...
            return view('admin.pages.service-full-option.index', compact('service', 'serviceClass', 'serviceInformation'));
        }
        return abort(404);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.pages.service-full-option.create', compact('service_id', 'service_season_id', 'servicesType'));
    }
    ...
    public function saveInformation(Request $request)
    {
        ...
        return redirect()->route('admin.service-full-option.index', ['service_id' => $request->service_id])->with('alert', config('ajax.messages.success.created'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.service-full-option.index', ['service_id' => $request->service_id, 'service_season_id' => $request->service_season_id])->with('alert', config('ajax.messages.success.created'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.service-full-option.edit', compact('serviceOption', 'servicesType'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.service-full-option.index', ['service_id' => $serviceOption->service_id, 'service_season_id' => $serviceOption->service_season_id])->with('alert', config('ajax.messages.success.created'));
    }
