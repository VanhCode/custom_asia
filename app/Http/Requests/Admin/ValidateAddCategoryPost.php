...
class ValidateAddCategoryPost extends FormRequest
{
    ...
    public function rules()
    {
        $rule = [
            ...
            "icon_path" => "mimes:jpeg,jpg,png,webp,svg|nullable|file|max:3000",
            "active" => "required",
        ];
    ...
    public function messages()
    {
        return     [
            ...
            "icon.mimes" => "icon category in jpeg,jpg,png,webp,svg",
            "icon_path.max" => "icon category size < 3mb",
            "avatar.mimes" => "avatar category in jpeg,jpg,png,webp,svg",
