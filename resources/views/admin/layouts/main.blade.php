...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('lib/adminlte/css/adminlte.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('lib/sweetalert2/css/sweetalert2.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('lib/select2/css/select2.min.css') }}" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_asset/css/stylesheet.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/lib/jquery-ui/jquery-ui.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/lib/leaflet/leaflet.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('lib/toastr/toastr.min.css') }}">
    <style>
