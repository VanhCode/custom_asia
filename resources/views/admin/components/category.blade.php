            ...
            <div class="d-flex">
                <div class="box-left lb_list_content_recusive ">
                    <div class="d-flex">
                        ...
                        <div class="col-sm-3  pt-2 pb-2 parent text-center wrap-load-active" data-url="{{ route($routeLoadActive,['id'=>$value->id]) }}">
                            @include('admin.components.load-change-active',['data'=>$value,'type'=>'danh mục'])
                         </div>
                        <div class="col-sm-2  pt-2 pb-2 parent text-center wrap-load-hot" data-url="{{ route($routeLoadHot,['id'=>$value->id]) }}">
                            @include('admin.components.load-change-hot',['data'=>$value,'type'=>'danh mục'])
                         </div>
                    </div>
                </div>
