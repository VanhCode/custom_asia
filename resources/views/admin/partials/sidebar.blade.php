...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #2A3F54;">
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3  d-flex" style="padding: 0px 0 0 0;">
            <div class="image">
                <img src="{{ Auth::guard('admin')->user()->avatar_path ? Auth::guard('admin')->user()->avatar_path : asset('admin_asset/images/username.png') }}"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.contact.booking') }}" class="nav-link">
                        <i class="fas fa-id-card-alt"></i>
                        <p>Thông tin liên hệ</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.service-full.index') }}" class="nav-link">
                                <i class="fas fa-angle-double-right"></i>
                                <p>Service Full Tour</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.service-class.index') }}" class="nav-link">
                                <i class="fas fa-angle-double-right"></i>
                                <p>Service class</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.service-other.index') }}" class="nav-link">
                                <i class="fas fa-angle-double-right"></i>
                                <p>Service other</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.service-type.index') }}" class="nav-link">
                                <i class="fas fa-angle-double-right"></i>
                                <p>Service type</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.additional-fee.index') }}" class="nav-link">
                                <i class="fas fa-angle-double-right"></i>
                                <p>Additional Fee</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.my-trip.index') }}" class="nav-link">
                        <i class="fas fa-cart-plus"></i>
                        <p>My Trip</p>
                    </a>
                </li>
