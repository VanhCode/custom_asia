                                ...
                                <div class="card-tools w-100 mb-3">
                                    <form action="{{ route('admin.galaxy.index') }}" method="GET">
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3 mb-0" style="min-width:100px;">
                                                        <select id="" name="fill_action" class="form-control">
                                                            ...
                                                            <option value="hot" {{ $fill_action=='hot'? 'selected':'' }}>Review nổi bật</option>
                                                            <option value="noHot" {{ $fill_action=='noHot'? 'selected':'' }}>Review không nổi bật</option>
                                                        </select>
                                                    </div>
                                                    {{--<div class="form-group col-md-3 mb-0" style="min-width:100px;">
                                            ...
                                            <div class="col-md-1 mb-0">
                                                <a  class="btn btn-danger w-100" href="{{ route('admin.galaxy.index') }}">Làm lại</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <table class="table table-head-fixed" style="font-size:13px;">
                                    ...
                                    @foreach($data as $reviewItem)
                                        <tr>
                                            ...
                                            <td class="wrap-load-active" data-url="{{ route('admin.galaxy.load.active',['id'=>$reviewItem->id]) }}">
                                                @include('admin.components.load-change-active',['data'=>$reviewItem,'type'=>'review'])
                                            </td>
                                            <td class="wrap-load-hot" data-url="{{ route('admin.galaxy.load.hot',['id'=>$reviewItem->id]) }}">
                                                @include('admin.components.load-change-hot',['data'=>$reviewItem,'type'=>'review'])
                                            </td>
                                            ...
                                            <td class="white-space-nowrap">
                                                ...
                                                <a href="{{route('admin.galaxy.edit',['id'=>$reviewItem->id])}}" class="btn btn-sm btn-info tooltip11"><i class="fas fa-edit"></i><span class="tooltiptext">Sửa</span></a>
                                                <a data-url="{{route('admin.galaxy.destroy',['id'=>$reviewItem->id])}}" class="btn btn-sm btn-danger lb_delete tooltip11"><i class="far fa-trash-alt"></i><span class="tooltiptext">Xóa</span></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
