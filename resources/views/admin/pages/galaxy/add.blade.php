            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form class="form-horizontal" action="{{ route('admin.galaxy.store') }}" method="POST"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            @error('slug_' . $langItem['value']) is-invalid  @enderror"
                                                                                    ...
                                                                                    placeholder="Nhập slug"> @error('slug_'
                                                                                    . $langItem['value'])
                                                                                    <div class="invalid-feedback d-block">
                                                                                        {{ $message }}</div>
                                                                                @enderror
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text"
                                                                                    ...
                                                                                    id="col"
                                                                                    value="{{ old('col_' . $langItem['value']) }}"
                                                                                    name="col_{{ $langItem['value'] }}"
                                                                                    placeholder="Nhập col"> @error('col_' .
                                                                                    $langItem['value'])
                                                                                    <div class="invalid-feedback d-block">
                                                                                        {{ $message }}</div>
                                                                                @enderror
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="avatar_path"
                                                                        class="form-control input-file-change"
