                        ...
                        <table class="table table-head-fixed" style="font-size: 13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input data-url="{{ route('admin.loadOrderVeryModel',['table'=>'codes','id'=>$codeItem->id]) }}" class="lb-order text-center"  type="number" min="0" value="{{ $codeItem->order?$codeItem->order:0 }}" style="width:50px" />
                                    {{-- <td><img src="{{asset($codeItem->image_path)}}" alt="{{$codeItem->name}}" style="width:80px;"></td> --}}
                                    {{--<td class="wrap-load-active" data-url="{{ route('admin.code.load.active',['id'=>$codeItem->id]) }}">
                                        @include('admin.components.load-change-active',['data'=>$codeItem,'type'=>'code'])
                                     </td>--}}
                                    <td>
                                        <a href="{{route('admin.code.edit',['id'=>$codeItem->id])}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Sửa</a>
