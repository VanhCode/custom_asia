...
@section('title', 'Thêm danh mục galaxy')
@section('content')
    <div class="content-wrapper">
        @include('admin.partials.content-header', [
            'name' => 'Category galaxy',
            'key' => 'Thêm danh mục galaxy',
        ])
        <!-- Main content -->
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form class="form-horizontal" action="{{ route('admin.categorygalaxy.store') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    @if (old('parent_id'))
                                                        {!! \App\Models\CategoryGalaxy::getHtmlOptionAddWithParent(old('parent_id')) !!}
                                                    @else
                                                        {!! $option !!}
                                                    @endif
                                                </select>
