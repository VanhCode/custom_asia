                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box-link">
                            ...
                            <a href="{{ route('admin.product.option', ['product_id' => $data->id]) }}"
                                class="btn btn-sm btn-success">Danh sách Màu</a>
                                                            ...
                                                            <div id="tong_quan_{{ $langItem['value'] }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @error('tinhtrang_' . $langItem['value']) is-invalid @enderror"
                                                                                ...
                                                                                value="{{ old('tinhtrang_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->tinhtrang }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @error('baohanh_' . $langItem['value']) is-invalid @enderror"
                                                                                ...
                                                                                value="{{ old('baohanh_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->baohanh }}"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('description_' . $langItem['value']) is-invalid @enderror"
                                                                                name="description_{{ $langItem['value'] }}" id="editer1" rows="3" placeholder="Nhập giới thiệu trái">{{ old('description_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->description }}</textarea>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('content2_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="content2_{{ $langItem['value'] }}" id="editer3" rows="20" value=""
                                                        ...
                                                        <div class="list-image d-flex flex-wrap">
                                                            @foreach ($data->images()->get() as $productImageItem)
                                                                <div class="col-image" style="width:20%;">
                                                                    <img class=""
                                                                        src="{{ $productImageItem->image_path }}"
                                ...
                                <div class="col-md-4">
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body table-responsive p-3">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="">Sản phẩm khuyến mại</label>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="checkbox"
                                                            class="form-check-input @error('sp_ngoc') is-invalid @enderror"
                                                            value="1" name="sp_ngoc"
                                                            @if (old('sp_ngoc') === '1' || $data->sp_ngoc == 1) {{ 'checked' }} @endif>
                                                    </label>
                                                </div>
                                                @error('sp_ngoc')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                            ...
                                            <div class="item-price-default">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0"
                                                        ...
                                                        value="{{ old('old_price') ?? $data->old_price }}" name="old_price"
