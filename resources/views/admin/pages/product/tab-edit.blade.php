            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box-link">
                            <a href="{{ route('admin.product.tab', ['product_id' => $data->product_id]) }}"
                                class="btn btn-sm btn-success">Danh sách tab</a>
                        </div>

                        <form class="form-horizontal" action="{{ route('admin.product.tab.update', ['id' => $data->id]) }}"
