...
@section('title', 'Update service class')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row"
                                        action="{{ route('admin.service-class.update', ['service_class' => $serviceClass->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('name') ?? $serviceClass->name }}" name="name">
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('order') ?? $serviceClass->order }}">
                                                @if ($errors->has('order'))
                                                ...
                                                <div class="d-flex">
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="1"
                                                            id="status-active"
                                                            @if (old('active') === '1' || $serviceClass->active == 1) {{ 'checked' }} @endif>
                                                        <label for="status-active">Active</label>
                                                    </div>
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="0" id="status-hide"
                                                            @if (old('active') === '0' || $serviceClass->active == 0) {{ 'checked' }} @endif>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" id="description" class="ckeditor">
                                                {{ old('description') ?? $serviceClass->description }}
                                            </textarea>
                                        </div>
