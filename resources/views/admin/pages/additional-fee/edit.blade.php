...
@section('title', 'Update Additional fee')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row"
                                        action="{{ route('admin.additional-fee.update', ['additional_fee' => $serviceOther->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="name" placeholder="Additional fee"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    id="price" placeholder="Additional fee"
                                                    value="{{ old('price') ?? $serviceOther->price }}" name="price">
                                                @if ($errors->has('price'))
