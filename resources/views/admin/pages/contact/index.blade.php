                                    ...
                                    <form action="{{ route('admin.contact.index') }}" method="GET">
                                        <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4 mb-0" style="min-width:100px;">
                                                        <select id="order" name="order_with" class="form-control">
                                                            ...
                                                            <option value="dateASC"
                                                                {{ $order_with == 'dateASC' ? 'selected' : '' }}>Ngày gửi
                                                                tăng
                                                                dần</option>
                                                            <option value="dateDESC"
                                                                {{ $order_with == 'dateDESC' ? 'selected' : '' }}>Ngày gửi
                                                                giảm
                                                                dần</option>
                                            ...
                                            <div class="col-md-4 text-right">
                                                ...
                                                <a href="{{ route('admin.contact.index') }}" class="btn btn-danger">Làm
                                                    lại</a>
                                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $contact)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        @if ($contact->address_detail)
                                                            <li>
                                                                <strong>Country:</strong> {{ $contact->address_detail }}
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </td>
                                                <td class="text-nowrap">
                                                    {{ $contact->user_id ? 'Thành viên' : 'Khách vãng lai' }}</td>
                                                <td class="text-nowrap status-2"
                                                    data-url="{{ route('admin.contact.loadNextStepStatus', ['id' => $contact->id]) }}">
                                                ...
                                                <td class="text-nowrap"> {{ date_format($contact->created_at, 'd/m/Y') }}
                                                </td>
                                                <td>
                                                    ...
                                                    <a href=""
                                                        data-url="{{ route('admin.contact.destroy', ['id' => $contact->id]) }}"
