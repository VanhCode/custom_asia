...
@section('title', 'Update service full tour')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row"
                                        action="{{ route('admin.service-full.update', ['service_full' => $service->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-6">
                                                ...
                                                <div class="d-flex">
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="1"
                                                            id="status-active"
                                                            @if (old('active') === '1' || $service->active == 1) {{ 'checked' }} @endif>
                                                        <label for="status-active">Active</label>
                                                    </div>
                                                    <div class="radio-group px-2">
                                                        <input type="radio" name="active" value="0" id="status-hide"
                                                            @if (old('active') === '0' || $service->active == 0) {{ 'checked' }} @endif>
                                        ...
                                        <div class="mt-3 d-flex justify-content-end col-12">
                                            <a href="{{ route('admin.service-full.index', ['parent_id' => request()->parent_id ?? 0]) }}"
