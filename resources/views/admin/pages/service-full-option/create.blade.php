...
@section('title', 'Create service option full tour')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-primary mt-3">
                            <div class="card-body table-responsive lb-list-category">
                                <div>
                                    <form class="row" action="{{ route('admin.service-full-option.store') }}"
                                        method="POST">
                                        @csrf
                                        <input type="hidden" name="service_id" value="{{ $service_id }}">
                                        <input type="hidden" name="service_season_id" value="{{ $service_season_id }}">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Service option:</label>
                                                <input type="text"
                                                    class="form-control @if ($errors->has('name')) is-invalid @endif"
                                                    id="name" placeholder="Service option" value="{{ old('name') }}"
                                                    name="name">
                                                @if ($errors->has('name'))
                                                ...
                                                <select name="service_type_id" id="service_type_id"
                                                    ...
                                                    @foreach ($servicesType as $key => $value)
                                                        <option value="{{ $value->id }}"
                                                            ...
                                                            {{ old('service_type_id') == $value->id ? 'selected' : '' }}>
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="type" placeholder="Type" value="{{ old('type') }}"
                                                    name="type">
                                                @if ($errors->has('type'))
