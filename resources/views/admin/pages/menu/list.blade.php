                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="text-right">
                            <a href="{{ route('admin.menu.create', ['parent_id' => request()->parent_id ?? 0]) }}"
                        ...
                        @if (isset($parentBr) && $parentBr)
                            <ol class="breadcrumb">
                                ...
                                @foreach ($parentBr->breadcrumb as $item)
                                    <li><a
                                            href="{{ route('admin.menu.index', ['parent_id' => $item['id']]) }}">{{ $item['name'] }}</a>
                                    </li>
                                @endforeach
                                <li><a
                                        href="{{ route('admin.menu.index', ['parent_id' => $parentBr->id]) }}">{{ $parentBr->name }}</a>
                                </li>
                            </ol>
                        @endif
