                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal"
                            action="{{ route('admin.categoryproduct.update', ['id' => $data->id]) }}" method="POST"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('content_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="content_{{ $langItem['value'] }}" id="editer" rows="20" value="" placeholder="Nhập nội dung">{{ old('content_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->content }}</textarea>
                                                ...
                                                <div id="hinh_anh" class="container tab-pane fade"><br>
                                                        ...
                                                        @if ($data->icon_path)
                                                            <div class="box-avatar">
                                                                ...
                                                                <a class="btn btn-sm btn-danger lb_delete_icon"
                                                                    data-url="{{ route('admin.categoryproduct.delete_icon_path', ['id' => $data->id]) }}"><i
                                                    ...
                                                    {{-- <div class="wrap-load-image mb-3">
                                                        ...
                                                        @if ($data->file)
                                                            <div class="box-avatar">
                                                                <img class="img-load border p-1 w-100"
                                                                    src="{{ $data->file }}" alt="{{ $data->name }}"
                                                                    style="height: 200px;object-fit:cover; max-width: 260px;">
                                                                <a class="btn btn-sm btn-danger lb_delete_banner"
                                                                    data-url="{{ route('admin.categoryproduct.delete_file', ['id' => $data->id]) }}"><i
                                                                        class="far fa-trash-alt"></i></a>
                                                            </div>
                                                        @endif
                                                    </div> --}}
