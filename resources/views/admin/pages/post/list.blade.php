                                ...
                                <table class="table table-head-fixed" style="font-size:13px;">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>ID</th>
                                            <th>Name</th>
                                            <th class="white-space-nowrap">Người đăng</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $postItem)
                                            <tr>
                                                ...
                                                <td>{{ $postItem->id }}</td>
                                                <td>{{ $postItem->name }}</td>
                                                <td>{{ App\Models\Admin::where('id', $postItem->admin_id)->first()->name ?? '' }}
                                                </td>
                                    ...
                                    <td>{{$postItem->updated_at}}</td> --}}
                                                <td class="white-space-nowrap">
                                                    ...
                                                    <a href="{{ route('admin.post.edit', ['id' => $postItem->id]) }}"
                                                        ...
                                                        onclick="localStorage.setItem('urlListPost', window.location.href);"><i
