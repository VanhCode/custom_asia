                                            ...
                                            <div class="infor-order mb-3">
                                                ...
                                                <ul class="list-infor">
                                                    ...
                                                    <li><span>Số lượng: </span>
                                                        {{ $data->orders()->get()->toArray()[0]['quantity'] ?? 1 }}</li>
                                                    <li><span>Giao đến: </span> {{ $data->address_detail }} (nhân viên sẽ
                                                        gọi xác nhận trước khi giao).</li>
                                                    <li class="total-price"><span>Tổng tiền: </span>
                                                        {{ number_format($data->total) }} {{ $unit ?? 'VNĐ' }}</li>
                                                </ul>
                                                                ...
                                                                <div class="order-item">
                                                                    <div class="media p-0">
                                                                        <div class="image position-relative">
                                                                            <a href="{{ $productItem->slug_full }}"> <img
                                                                                    src="{{ $productItem->avatar_path }}"
                                                                        ...
                                                                        <div class="media-body pl-3">
                                                                            <div class="content">
                                                                                <h4><a
                                                                                        href="{{ $productItem->slug_full }}">{{ $productItem->name }}</a>
                                                                                </h4>
                                                                            </div>
                                                                        </div>
                                                                    </div>
