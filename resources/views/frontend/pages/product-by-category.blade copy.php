    ...
    @if (isset($category->parent))
        <section class="page-banner p-relative">
            <div class="page-banner-img p-absolute top-0 left-0 right-0 bottom-0">
                <img class="h-100 w-100" src="{{ asset($category->parent->file) ?? 'asset(public/frontend/images/backgound.webp)' }}"
    ...
    <section class="tour-search pd-section-bottom pd-section-top">
        <div class="ctnr">
            ...
            <div class="row js-between pd-section-content">
                ...
                <div class="clm" style="--w-xl: 2.2;  --w-xs: 12;">
                    <div class="filter">
                        ...
                        <div class="filter-box progress-box">
                            ...
                            <input type="range" value="0" min="0" max="{{ $maxPrice }}" step="10"
                            ...
                            @foreach ($data as $item)
                                <div class="clm" style="--w-lg: 4; --w-sm: 6; --w-xs: 12;">
                                    <div class="products-card">
                                        <a href="{{ $item->slug }}" class="products-card__img d-block">
                                        ...
                                        <div class="products-card-content">
                                            ...
                                            <div class="d-flex ai-end js-between products-card-bottom">
                                                <a href="{{ $item->slug }}" class="see-more">
                                                    Details
                                                </a>
                                                <div class="price">
                                                    <div class="price-top">
