...
$(document).on("click", ".lb_delete_avatar", actionDeleteAvatar);
$(document).on("click", ".lb_delete_icon", actionDeleteAvatar);
$(document).on("click", ".lb_delete_banner", actionDeleteAvatar);
...
function actionDeleteAvatar(event) {
    event.preventDefault();
    let urlRequest = $(this).data("url");
    let mythis = $(this);
    Swal.fire({
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.code == 200) {
                        ...
                        mythis.parents(".box-avatar").remove();
                    }
                },
                error: function() {
